                            ...
                            <div class="col-lg-6">
                                <div class="mt-3 mt-lg-0">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" name="photo" type="file"  id="imagePhoto">
                                    </div>
                                    <div class="mb-3">
                                        
                                        <img id="showImagePhoto" src="{{ (!empty($profileData->photo)) ? url('upload/client_images/'.$profileData->photo) : url('upload/no_image.jpg') }}" alt="" class="rounded-circle p-1 bg-primary" width="110">
                                    </div>
                                    <div class="mt-4">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#imagePhoto').change(function(e){
            var reader = new FileReader();
            reader.onload = function(e){
                $('#showImagePhoto').attr('src',e.target.result);
            }
            reader.readAsDataURL(e.target.files['0']);
        })
    })
